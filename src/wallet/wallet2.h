...
namespace tools
{
  ...
  public:
    ...
    void init(const std::string& daemon_address = "http://localhost:11179", uint64_t upper_transaction_size_limit = CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE - CRYPTONOTE_COINBASE_BLOB_RESERVED_SIZE);
    bool deinit();
